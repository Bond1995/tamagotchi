...
public class Tamagotchi {
	...
	public static final int MIN = 0; // Valore minimo di affetto e cibo
	public static final int MAX = 100; // Valore massimo di affetto e cibo
	public static final int MIN_AFFETTO = 0; // Valore minimo di affetto sotto il quale il tamagotchi muore
	public static final int MIN_CIBO = 30; // Valore minimo di cibo sotto il quale il tamagotchi muore
	public static final int MAX_CIBO = 90; // Valore massimo di cibo sopra il quale il tamagotchi muore
	public static final double COST_CAREZZE = 0.5; // Costante per la diminuzione di cibo date le carezze
	public static final double COST_CORREZIONE_CAREZZE = 20; // Costante per la diminuzione di carezze rispetto al contatore
	public static final double COST_BISCOTTI_1 = 0.1;  // Costante per l'aumento di cibo dati i biscotti
	public static final double COST_BISCOTTI_2 = 0.25; // Costante per la diminuzione di affetto dati i biscotti
	public static final String TEXT_INFO = "Il tuo tamagotchi %s ha %.1f di affetto e %.1f di cibo.\n";
	public static final String TEXT_MORTO = "Purtroppo il tuo tamagotchi è morto. :((\n";
	public static final String TEXT_VIVO = "Il tuo tamagotchi è vivo!\n";
	public static final String TEXT_TRISTE = "Purtroppo il tuo tamagotchi è triste :(\n";
	public static final String TEXT_FELICE = "Il tuo tamagotchi è felice!\n";
